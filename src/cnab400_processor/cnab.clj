...
(def cnab240-segment-o
  [:bank-code 1 3 to-string
   :lot-code 4 7 to-string
   :register-type 8 8 to-string
   :register-number 9 13 to-string
   :segment 14 14 to-string
   :move-type 15 17 to-string
   :barcode 18 65 to-string
   :name 66 95 to-string-trim
   :due-date 96 103 to-date-4
   :currency 104 106 to-string
   :currency-amount 107 121 to-bigdec
   :value 122 136 to-bigdec
   :payment-date 137 144 to-date-4
   :paid-value 145 159 to-bigdec
   :whites 160 162 to-string
   :fiscal-note 163 171 to-string
   :whites-2 172 174 to-string
   :our-number 175 194 to-string
   :whites 195 215 to-string
   :your-number 216 230 to-string
   :occurrences 231 240 to-string])
